...
def index_range(page: int, page_size: int) -> Tuple[int, int]:
    ...
    that containing the start and end index corresponding to
    the range of indexes to return in a list for those pagination
    parameters
    Args:
...
class Server:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        Takes 2 integer arguments and returns requested page from  dataset
        Args:
