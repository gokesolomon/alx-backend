#!/usr/bin/env python3
"""
It Contains class with methods to create simple
...
class Server:
    ...
    def dataset(self) -> List[List]:
        """
        It reads from csv file and returns the dataset.
        Returns:
    ...
    def assert_positive_integer_type(value: int) -> None:
        """
        It confirms that the value is a positive integer.
        Args:
    ...
    def get_page(self, page: int = 1, page_size: int = 10) -> List[List]:
        """
        It returns a page of the dataset.
        Args:
